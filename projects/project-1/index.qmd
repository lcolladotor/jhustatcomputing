...
Consider playing around with the `theme()` function to make the figure shine, including playing with background colors, font, etc. See <https://github.com/lcolladotor/jhustatcomputing2023/issues/4> for an example on how you can choose colors if you have too many categories.
