...
**Due date: October 25th at 11:59pm**
...
8.  Using `ggplot2`, create a scatter plot of the average sentiment score for each album (y-axis) and the album release date along the x-axis. Make the size of each point the album sales in millions.
