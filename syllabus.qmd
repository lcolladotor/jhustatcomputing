...
-   Yanting Hu ([yhu157\@jh.edu](mailto:yhu157@jh.edu))
...
-   Project 0: end of week 2 (Sunday September 7, 11:59pm) (entirely optional and not graded but hopefully useful and fun)
-   Project 1: end of week 3 (Sunday September 14, 11:59pm)
-   Project 2: end of week 5 (Sunday September 28, 11:59pm)
-   Project 3: end of week 8 (Sunday October 19, 11:59pm)
...
You must install [R](https://cran.r-project.org) and [RStudio IDE](https://posit.co/products/open-source/rstudio/?sid=1) or [Positron](https://positron.posit.co/download.html) (available from [Posit](https://posit.co/)) on your computing environment in order to complete this course. These are three **different** applications that must be installed separately before they can be used together:
