...
-   Emily Norton ([enorton7\@jhmi.edu](mailto:enorton7@jhmi.edu))
-   Joe Sartini ([jsartin1\@jhu.edu](mailto:jsartin1@jhu.edu))
-   Phyllis Wei ([ywei43\@jhu.edu](mailto:ywei43@jhu.edu))

### Office hours

Instructor and TA office hours are [announced on CoursePlus](https://courseplus.jhu.edu/core/index.cfm/go/pb:page.view/coID/19543/pageID/145832/). If there are conflicts and/or need to cancel office hours, announcements will be made on CoursePlus.
...
To submit a late homework, send it via email to the instructor and all TAs. That way everyone involved will receive the same communication and we can avoid any confusion and/or misunderstandings. Thank you.
