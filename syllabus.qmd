...
I also welcome the use of AI in coding through [Posit Assistant](https://positron.posit.co/assistant.html) (so you don't have to copy paste into a browser). For `Posit Assistant` to work, you have to have access to `GitHub Copilot Pro`, `Posit AI`, `Claude Anthropic`, or some other service that gives you AI tokens. This will be useful to you regardless of your pre-existing level of familiarity with R and coding. Some of you might already have access to [GitHub Copilot](https://github.com/features/copilot) Pro through the [GitHub Education Pack](https://education.github.com/pack), otherwise you can sign up for it (it takes a few days to get verified). Alternatively, you might want to sign up for the 30 day [Posit AI](https://posit.co/products/ai) free trial (about $20 / month afterward).
