...
* Use `usethis::use_course()` as documented at <https://usethis.r-lib.org/reference/zip-utils.html>.

To make it easier for you, I wrote the R code you can run inside your `RStudio IDE` project / `Positron` directory for your class notes. Your equivalent to <https://github.com/lcolladotor/biostat776classnotes>. See [these lines of code](https://github.com/lcolladotor/biostat776classnotes/blob/92b6fd7a6eda9f64aab47dc0f741df4f35474a9d/R/2024-09-03.R#L47-L76) for the details.
:::
...
|  |  | `r emojifont::emoji('computer')` Reproducible Research \[[html](posts/04-reproducible-research/index.html)\] \[[Qmd](https://github.com/lcolladotor/jhustatcomputing/blob/main/posts/04-reproducible-research/index.qmd)\] \[[R](https://github.com/lcolladotor/jhustatcomputing/blob/main/posts/04-reproducible-research/index.R)\] |  |  |
...
|  |  |  |  |  |
|  | Sept 13 |  | \``r emojifont::emoji('fallen_leaf')` Project 0 due |  |
|  |  |  |  |  |
...
|  |  |  |  |  |
|  | Sept 20 |  | `r emojifont::emoji('fallen_leaf')` Project 1 due |  |
|  |  |  |  |  |
...
|  |  |  |  |  |
| Week 5 (classes will be on Zoom this week) | Lecture 9 | `r emojifont::emoji('nut_and_bolt')` Loop functions \[[html](posts/17-loop-functions/index.html)\] \[[Qmd](https://github.com/lcolladotor/jhustatcomputing/blob/main/posts/17-loop-functions/index.qmd)\] \[[R](https://github.com/lcolladotor/jhustatcomputing/blob/main/posts/17-loop-functions/index.R)\] |  |  |
|  |  |  |  |  |
...
|  |  |  |  |  |
|  | Oct 4 |  | `r emojifont::emoji('fallen_leaf')` Project 2 due |  |
|  |  |  |  |  |
...
|  |  |  |  |  |
|  | Oct 25 |  | `r emojifont::emoji('fallen_leaf')` Project 3 due |  |
