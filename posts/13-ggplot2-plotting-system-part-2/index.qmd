...
1.  <https://r4ds.hadley.nz/data-visualize.html>
...
::: callout-tip
_From CoursePlus Discussion forum on 2025-09-10:_
...
* `biocViews` for Bioconductor packages <https://bioconductor.org/packages/release/BiocViews.html#___Software>
Bioconductor release notes such as <https://bioconductor.org/news/bioc_3_23_release/> for version 3.23 (the latest one as of September 2026). See <https://bioconductor.org/about/release-announcements/> for the full list of release note announcements. We've done this activity a few times at the [LIBD RStats club](https://research.libd.org/rstatsclub/) such as <https://youtu.be/13bIatqNHH8> for bioc version 3.14.
...
In this lesson, we will get into the nitty gritty of **how `ggplot2` builds plots** and how you can customize various aspects of any plot.

While we can use the `ggplot2::qplot()` function to quickly put points on a page as [described in this optional lecture](../12-ggplot2-plotting-system-part-1/).
...
Let's use the `ggplot()` function in another dataset, namely the [palmerpenguins](https://allisonhorst.github.io/palmerpenguins/) dataset. Check out [this post explaining the controversy](https://www.meganstodel.com/posts/no-to-iris/) with the `iris` dataset which was previously used in many examples. 
...
To visualize this we can **add a `facet_grid()`**, which takes a _formula_ argument.
...
P.S. Follow [Christine Zhang on Bluesky](https://bsky.app/profile/christinezhang.bsky.social) or [Twitter / X](https://twitter.com/christinezhang) for more [#dataviz](https://bsky.app/search?q=%23dataviz) and data journalism.

<iframe width="560" height="315" src="https://www.youtube.com/embed/hZEMksgE6LI?si=gcgtO7ioex-0fxuf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

You might want to watch her guest lecture for this course from October 16th, 2025.
...
[Here](https://github.com/LieberInstitute/Visium_SPG_AD/blob/master/plots/09_pathology_vs_BayesSpace/pathology_groups_colorblind.pdf) you can find an example of an actual use case for my work that I made with [this script](https://github.com/LieberInstitute/Visium_SPG_AD/blob/master/code/09_pathology_vs_BayesSpace/04_label_pathology_spots.R). This work was published at doi: [10.1089/genbio.2023.0019](https://doi.org/10.1089/genbio.2023.0019).
