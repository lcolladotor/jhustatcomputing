...
Bioconductor release notes such as <https://bioconductor.org/news/bioc_3_21_release/> for version 3.21 (the latest one). See <https://bioconductor.org/about/release-announcements/> for the full list of release note announcements. We've done this activity a few times at the [LIBD RStats club](https://research.libd.org/rstatsclub/) such as <https://youtu.be/13bIatqNHH8> for bioc version 3.14.
