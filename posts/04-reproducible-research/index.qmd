...
### Example: Leo's work in neuroscience

<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7366586600010481666" height="1061" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>

This was posted by coincidence 14 hours before I was going to give this lecture on 2025-08-28.
...
-   Resources like [GitHub](https://github.com), [kipoi](https://kipoi.org), and [RPubs](http://rpubs.com) (sadly it'll be retired in June 2027 and replaced by *Posit Cloud* as documented on [this blog post](https://posit.co/blog/migrating-connect-cloud-posits-unified-publishing-solution)) and various data repositories have made a big difference, but there is still a ways to go with respect to building up the public reproducibility infrastructure.
...
-   The directory where you have an `RStudio IDE` project file (`*.Rproj`). For `RStudio IDE` projects with a `git` repository, this is typically the same directory.

    * Note that this file is not used by `Positron` which makes it even more important to use `git` on your project folders (directories). See <https://positron.posit.co/migrate-rstudio-rproj.html> for more details.
...
Check <https://github.com/LieberInstitute/template_project/blob/devel/code/01_read_data_to_r/01_read_data_to_r.R> for a full script example part of <https://github.com/LieberInstitute/template_project>.
