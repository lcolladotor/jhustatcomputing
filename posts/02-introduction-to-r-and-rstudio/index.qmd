...
Here's a recent example from BlueSky [#RStats](https://bsky.app/search?q=%23RStats):
...
-   If you have not already, [install R first](http://cran.r-project.org). If you already have R installed, make sure it is a fairly recent version, version 4.5.1 or newer. If yours is older than version 4.5.0, I suggest you update (install a new R version).
-   Once you have R installed, install the free version of [RStudio Desktop](https://posit.co/download/rstudio-desktop/). Again, make sure it's a recent version.
-   Alternatively, install the latest version of [Positron](https://positron.posit.co/download.html).
