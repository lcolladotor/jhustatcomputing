...
-   There are also over 2,000 packages associated with the [Bioconductor project](http://bioconductor.org).
...
-   If you have not already, [install R first](http://cran.r-project.org). If you already have R installed, make sure it is a fairly recent version, version 4.3.1 or newer. If yours is older that version 4.2.0, I suggest you update (install a new R version).
