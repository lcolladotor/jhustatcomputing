...
1.  <https://r4ds.hadley.nz/strings.html>
:::
...
The [`stringr`](https://github.com/hadley/stringr) package, written by [Hadley Wickham](https://bsky.app/profile/hadley.nz), is part of the `tidyverse` group of R packages.
